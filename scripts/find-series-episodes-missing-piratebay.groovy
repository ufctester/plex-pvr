...
def getEpisodeName(seriesName,season,episode,includeSeparator=true) {
...
builder {
	download episodesMissing.collect{episode ->
		...
		def seasonEpisodeLabel=getEpisodeName(episode.seriesInfo.name,episode.season,episode.episode,false)
		
		log.info "statusLabel=${statusLabel} seasonEpisodeLabel=${seasonEpisodeLabel}"
		...
		return {
			...
			"DOWNLOAD_PERCENT" ""
			"PB_URL" "https://thepiratebay.org/search/" + seasonEpisodeLabel + "/0/7/0"
			"FILE" ""
			"DOWNLOADSIZE" ""
			"TOTALSIZE" ""
		}
